...
import menshoe1b from "../images/menshoe1b.png";
import menshoe1c from "../images/menshoe1c.png";
import menshoe1d from "../images/menshoe1d.png";
import menshoe1e from "../images/menshoe1e.png";
import menshoe1f from "../images/menshoe1f.png";
import menshoe1g from "../images/menshoe1g.png";
import menshoe1h from "../images/menshoe1h.png";
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "img1":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1a} alt="M" />
          </div>
        );
      ...
      case "img2":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1b} alt="M" />
          </div>
        );
      ...
      case "img3":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1c} alt="M" />
          </div>
        );
      ...
      case "img4":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1d} alt="M" />
          </div>
        );
      ...
      case "img5":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1e} alt="M" />
          </div>
        );
      ...
      case "img6":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1f} alt="M" />
          </div>
        );
      ...
      case "img7":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1g} alt="M" />
          </div>
        );
      ...
      case "img8":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe1h} alt="M" />
          </div>
        );
        ...
        <div className="text-white w-[95%] lg:w-[50%] h-[750px] leading-8  overflow-y-scroll hide-scrollbar scroll-smooth ">
          ...
          <div className=" p-4 ">
            ...
            <div className=" flex gap-2">
              <img className="h-40 w-40 rounded-md" src={menshoe1b} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe1c} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe1d} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe1e} alt="M" />
            </div>
            <br />
