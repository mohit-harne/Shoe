...
import kidshoe1a from "../images/kidshoe1a.png";
import kidshoe1b from "../images/kidshoe1b.png";
import kidshoe1c from "../images/kidshoe1c.png";
import kidshoe1d from "../images/kidshoe1d.png";
import kidshoe1e from "../images/kidshoe1e.png";
import kidshoe1f from "../images/kidshoe1f.png";
import kidshoe1g from "../images/kidshoe1g.jpeg";
import kidshoe1h from "../images/kidshoe1h.png";
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "img1":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1a} alt="M" />
          </div>
        );
      ...
      case "img2":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1b} alt="M" />
          </div>
        );
      ...
      case "img3":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1c} alt="M" />
          </div>
        );
      ...
      case "img4":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1d} alt="M" />
          </div>
        );
      ...
      case "img5":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1e} alt="M" />
          </div>
        );
      ...
      case "img6":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1f} alt="M" />
          </div>
        );
      ...
      case "img7":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1g} alt="M" />
          </div>
        );
      ...
      case "img8":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={kidshoe1h} alt="M" />
          </div>
        );
    ...
    <div className="bg-black lg:h-[2080px] md:h-[3245px] h-[3320px]  items-center justify-center pt-[200px]">
      <div className="grid lg:grid-cols-3  m-[100px]  h-[700px]  mt-[-100px] ">
        ...
        <div className="  ml-[-80px] w-[410px] h-[670px] pt-4 pl-2 pr-2 overflow-y-scroll hide-scrollbar scroll-smooth ">
          <h1 className="text-white text-3xl">Nike Dynamo 2 EasyOn</h1>
          <p className="text-[21px] text-white">Kids Shoes</p>
          <br />
        ...
        <div className="text-white w-[95%] lg:w-[50%] h-[750px] leading-8  overflow-y-scroll hide-scrollbar scroll-smooth ">
          ...
          <div className=" p-4 ">
            ...
            <div className=" flex gap-2">
              <img className="h-40 w-40 rounded-md" src={kidshoe1b} alt="M" />
              <img className="h-40 w-40 rounded-md" src={kidshoe1c} alt="M" />
              <img className="h-40 w-40 rounded-md" src={kidshoe1d} alt="M" />
              <img className="h-40 w-40 rounded-md" src={kidshoe1e} alt="M" />
            </div>
            <br />
