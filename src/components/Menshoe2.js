...
import menshoe2b from "../images/menshoe2b.png";
import menshoe2c from "../images/menshoe2c.png";
import menshoe2d from "../images/menshoe2d.png";
import menshoe2e from "../images/menshoe2e.png";
import menshoe2f from "../images/menshoe2f.png";
import menshoe2g from "../images/menshoe2g.png";
import menshoe2h from "../images/menshoe2h.png";
  ...
  const renderContent = () => {
    switch (activeTab) {
      case "img1":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2a} alt="M" />
          </div>
        );
      ...
      case "img2":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2b} alt="M" />
          </div>
        );
      ...
      case "img3":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2c} alt="M" />
          </div>
        );
      ...
      case "img4":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2d} alt="M" />
          </div>
        );
      ...
      case "img5":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2e} alt="M" />
          </div>
        );
      ...
      case "img6":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2f} alt="M" />
          </div>
        );
      ...
      case "img7":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2g} alt="M" />
          </div>
        );
      ...
      case "img8":
        return (
          <div className=" h-[580px] w-[280px] mt-[-500px]  md:h-[569px] md:w-[435px] md:mt-[-500px] md:ml-[100px]   lg:mt-0 lg:w-[535px] lg:h-[669px] lg:ml-[-250px]  ">
            <img className="rounded-md" src={menshoe2h} alt="M" />
          </div>
        );
    ...
    <div className="bg-black lg:h-[2080px] md:h-[3245px] h-[3320px] items-center justify-center pt-[200px]">
      <div className="grid lg:grid-cols-3  m-[100px]  h-[700px]  mt-[-100px] ">
        ...
        <div className="  ml-[-80px] w-[410px] h-[670px] pt-4 pl-2 pr-2 overflow-y-scroll hide-scrollbar scroll-smooth ">
          <h1 className="text-white text-3xl">AIR FORCE AIR HIGH 07</h1>
        ...
        <div className="text-white w-[95%] lg:w-[50%] h-[750px] leading-8  overflow-y-scroll hide-scrollbar scroll-smooth ">
          ...
          <div className=" p-4 ">
            ...
            <div className=" flex gap-2">
              <img className="h-40 w-40 rounded-md" src={menshoe2b} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe2c} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe2d} alt="M" />
              <img className="h-40 w-40 rounded-md" src={menshoe2e} alt="M" />
            </div>
            <br />
